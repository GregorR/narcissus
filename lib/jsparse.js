...
Narcissus.parser = (function() {
    ...
    /*
     * ExpressionScript :: (tokenizer) -> node
     *
     * Parses a top-level expression
     */
    function ExpressionScript(t) {
        var n = new Node(t, scriptInit()); // unused wrapper node for StaticContext
        return Expression(t, new StaticContext(n, n, false, false));
    }
    ...
    /*
     * parseExpression :: (source, filename, line number) -> node
     */
    function parseExpression(s, f, l) {
        var t = new lexer.Tokenizer(s, f, l);
        var n = ExpressionScript(t);
        if (!t.done)
            throw t.newSyntaxError("Syntax error");
